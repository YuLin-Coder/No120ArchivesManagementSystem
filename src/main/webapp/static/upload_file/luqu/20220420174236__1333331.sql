...
insert  into `t_a_user`(`id`,`create_date_time`,`name`,`pwd`,`remark`,`true_name`,`state`,`sex`,`phone`) values (3,'2020-03-09 14:03:20','002','002','备注002','张社长002002',2,1,'002002002'),(4,'2020-03-09 14:34:49','001','001','非常能干001','张社长0011',2,1,'001001001'),(6,'2020-03-09 19:56:57','123456','123456','33','小陈1',3,1,'1231111'),(7,'2020-03-10 10:36:21','admin','123456','','张无忌1111',1,1,'121`23`13123'),(8,'2020-03-11 13:19:01','003','003','比较爱笑。','张社长003',2,1,'21313145'),(9,'2020-03-12 21:14:07','004','004','123123','123',2,1,'123123'),(10,'2020-04-09 10:20:14','wuji','123456','无','无极',2,1,'12345678912'),(11,'2020-04-09 10:24:20','nihao123','123456',NULL,'小如3',3,2,'12345678955');

/*Table structure for table `t_b_association` */

DROP TABLE IF EXISTS `t_b_association`;

CREATE TABLE `t_b_association` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `content` longtext,
  `name` varchar(30) NOT NULL,
...
/*Data for the table `t_b_association` */

insert  into `t_b_association`(`id`,`content`,`name`,`user_id`,`create_date_time`) values (4,'<p>333111</p>','第1团',4,'2020-03-09 17:22:31'),(5,'<p>8888888<br/></p>','第2团',3,'2020-03-10 14:09:19'),(6,'<p>框架塔顶</p><p>&nbsp;fsd革asd 塔顶</p><p>&nbsp;模压432</p><p>423</p><p>423</p><p>4234</p><p>23423</p><p>423</p><p>4423</p><p>4234</p><p><br/></p><p><img src=\"/static/ueditor_upload/uploadimage/2020-03-11/202003111321_53357_未标题-1.jpg\" title=\"未标题-1.jpg\" alt=\"未标题-1.jpg\"/></p><p><br/></p><p><br/></p><p><img src=\"/static/ueditor_upload/uploadimage/2020-03-11/202003111322_15146_image.png\" title=\"image.png\" alt=\"image.png\"/></p><p>朝秦暮楚ffdasf</p><p><br/></p><p><br/></p><p><br/></p><p><br/></p>','003社团  xxxxx',8,'2020-03-11 13:22:43'),(7,'<p>这里可以写社团方面的介绍</p><p><br/></p><p><img src=\"/static/ueditor_upload/uploadimage/2020-05-20/202005200016_51546_image.png\" title=\"image.png\" alt=\"image.png\"/></p><p><br/></p><p><img src=\"/static/ueditor_upload/uploadimage/2020-05-20/202005200017_06221_image.png\" title=\"image.png\" alt=\"image.png\"/></p>','第八团',10,'2020-04-09 10:20:44');

/*Table structure for table `t_c_activity` */

DROP TABLE IF EXISTS `t_c_activity`;

CREATE TABLE `t_c_activity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `content` longtext,
  `create_date_time` datetime DEFAULT NULL,
  `state` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `FKel0mrykej9y5i4718oypi3akx` FOREIGN KEY (`association_id`) REFERENCES `t_b_association` (`id`),
  CONSTRAINT `FKpv30uitxlp45pkf60k5078l0h` FOREIGN KEY (`user_id`) REFERENCES `t_a_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

/*Data for the table `t_c_activity` */

insert  into `t_c_activity`(`id`,`content`,`create_date_time`,`state`,`title`,`association_id`,`user_id`) values (4,'<p>明天活动</p><p>明天活动</p><p><img src=\"http://img.baidu.com/hi/jx2/j_0002.gif\"/></p>','2020-03-11 00:25:08',3,'社团001  明天活动',4,4),(5,'<p>夺dsa&nbsp;</p><p>在a</p><p><img src=\"/static/ueditor_upload/uploadimage/2020-03-11/202003111127_59995_image.png\" title=\"image.png\" alt=\"image.png\"/></p>','2020-03-11 11:28:01',3,'社团2 的活动。。',5,3),(6,'<p><br/></p><p>dfasdfsdff asfd苛朝秦暮楚</p><p>&nbsp;</p><p><br/></p><p>魂牵梦萦fasd地asd地</p><p><br/></p><p><br/></p><p>需要a魂牵梦萦&nbsp;</p><p>魂牵梦萦 fsd工</p><p><br/></p><p><br/></p><p>夺s</p><p><img src=\"/static/ueditor_upload/uploadimage/2020-03-11/202003111328_17025_003.png\" title=\"003.png\" alt=\"003.png\" width=\"792\" height=\"306\"/></p><p><br/></p><p><br/></p>','2020-03-11 13:28:34',2,'申请 明天 下午去北京 的活动。',6,8),(7,'<p>12222222222</p>','2020-03-13 09:30:42',2,'111111111',4,4),(8,'<p>111111111111111</p>','2020-04-09 10:21:46',1,'111111111111111111111',7,10);

/*Table structure for table `t_c_apply` */

DROP TABLE IF EXISTS `t_c_apply`;

CREATE TABLE `t_c_apply` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `create_date_time` datetime DEFAULT NULL,
  `remark` varchar(200) DEFAULT NULL,
  `state` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `FK2407gbh3d4mq6fbma9fnsq669` FOREIGN KEY (`association_id`) REFERENCES `t_b_association` (`id`),
  CONSTRAINT `FKjca8q2a41ocfrhsti7gbsqpww` FOREIGN KEY (`user_id`) REFERENCES `t_a_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;

/*Data for the table `t_c_apply` */

insert  into `t_c_apply`(`id`,`create_date_time`,`remark`,`state`,`type`,`association_id`,`user_id`) values (7,'2020-03-11 10:09:37','夺械要 ',3,2,4,6),(8,'2020-03-11 11:18:12','11111111111',2,2,4,6),(9,'2020-03-11 11:26:24','我要加啊。',2,1,5,6),(10,'2020-03-11 11:26:39','我要加啊。`111',2,1,4,6),(11,'2020-03-11 13:29:37','我想加入。！！！',2,1,6,6),(12,'2020-03-11 13:30:49','加错了。',2,2,6,6),(13,'2020-04-09 10:25:01','22222222222',1,1,7,11);
...
insert  into `t_config`(`id`,`web_name`) values (1,'学生社团管理系统');
...
insert  into `t_message`(`id`,`content`,`create_date_time`,`user_id`) values (4,'1212','2020-03-19 20:22:21',6),(5,'321312','2020-03-19 20:22:23',6);
...
CREATE TABLE `t_user_association` (
  ...
  CONSTRAINT `FKn3kayk46c4m6d8safv7ts52wp` FOREIGN KEY (`association_id`) REFERENCES `t_b_association` (`id`)
